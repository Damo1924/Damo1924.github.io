...
1. 일을 직원에 매칭시키는 방법
2. 동일한 직원이 두 명이 있다고 생각하고 직원을 일에 매칭시키는 방법
...
두 번째 방법은 앞 문제를 풀었듯이 직원을 일에 매칭시키는 대신, 동일한 직원이 두 명 있다고 생각하는 것이다.

**직원 한 명 당 하나의 일을 할 수 있다는 조건을 유지하면서 동일한 직원이 하나 더 있다고 가정한다.**

즉, N명에 대해 일을 매칭시키는 문제에서 2N명에 대해 일을 매칭시키는 문제로 바꾸어서 풀 수 있다.
