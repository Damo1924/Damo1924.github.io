...
- **Tag**: Commit을 참조하기 쉽도록 이름을 붙이는 것
  ...
  - **Annotated Tag**(주석 태그): 이름, 설명, 만든 사람, 날짜 등의 정보를 포함하는 Tag<br/><br/>
