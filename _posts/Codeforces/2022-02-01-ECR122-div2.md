...
그런데 문제는 입력으로 주어지는 상수들의 범위가 너무 넓어서 극단적인 입력을 넣으면 `long long`의 범위도 초과할 수 있다는 것이었다.

허무하게도 이 문제는 브루트포스로 해결이 가능한 문제이다.
...
<img src="https://user-images.githubusercontent.com/88201512/152307067-18b7ba8e-58f3-44ad-9a9c-87aea8eb8a0c.jpg">
